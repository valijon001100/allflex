...
urlpatterns = [
    ...
    path('panel/genres/', admin_views.genre_list, name='admin_genre_list'),
    path('panel/genres/seed/', admin_views.genre_seed_defaults, name='admin_genre_seed'),
    path('panel/genres/add/', admin_views.genre_add, name='admin_genre_add'),
    path('panel/genres/<int:pk>/edit/', admin_views.genre_edit, name='admin_genre_edit'),
    path('panel/genres/<int:pk>/delete/', admin_views.genre_delete, name='admin_genre_delete'),
